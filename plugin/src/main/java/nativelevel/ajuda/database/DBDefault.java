...
public class DBDefault {
    ...
    public Connection criarConnection()
            throws SQLException {
        try {
            String endereco = "jdbc:mysql://localhost:3306/kom?autoReconnect=true&user=komuser&password=KomSenha&useSSL=false";
            try {
            ...
            this.connection = DriverManager.getConnection(endereco);
